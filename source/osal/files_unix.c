...
{
    // Implementacion nativa para Xbox 360: CreateDirectoryA tolera que la
    // carpeta ya exista (ERROR_ALREADY_EXISTS) sin considerarlo un fallo,
    // a diferencia de stat()/mkdir() POSIX que no resuelven bien las rutas
    // tipo "game:\..." del filesystem virtual del XDK.
    (void)mode;
