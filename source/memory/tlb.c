...
// zlib no disponible en este build; adler32 local (mismo algoritmo, dominio publico)
...
static __inline unsigned int tlb_access(unsigned int vaddr, int w)
{
	if(w==1)
	{
...
static __inline unsigned int goldeneye_hack(unsigned int vaddr, int w)
{
